...
Задаем имя пользвателя и почту, т.е. представляемся гиту перед началом использования. 

Используем эту команду дважды: первый раз с именем (**git config Name**), второй раз с почтой (**git config email**)
